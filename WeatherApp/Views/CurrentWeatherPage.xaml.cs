...
namespace WeatherApp.Views
{
    ...
    public partial class CurrentWeatherPage : ContentPage
    {
        ...
        {
            var url = $"http://api.openweathermap.org/data/2.5/weather?q={Location}&appid=6b6cb0310ff6c4d2944ce0c3bfb989e6&units=metric";
        ...
        {
            var url = $"http://api.openweathermap.org/data/2.5/forecast?q={Location}&appid=6b6cb0310ff6c4d2944ce0c3bfb989e6&units=metric";
            var result = await ApiCaller.Get(url);
